...
- [x] **2026-05-30** — Reorganização da tab Calculadora: novo `AnexosHeader` (tipado, extensível; mostra Rosto · Anexo A · Anexo H · Anexo F · Anexo D com estado obrigatório/conforme/fora-do-âmbito); `ExerciciosPanel` agora colapsa por defeito (toggle no topo `▸ Exercícios guardados (N)`); Calculator e BracketBar passam a grid 2-col (esquerda/direita) em ecrãs >900px, empilhando em mobile.
